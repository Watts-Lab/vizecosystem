...
datasets = [
  {
    'url': [
      ...
      # # # phone+tablet 
      'raw_data/PHN+TAB_all_adults_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_age_group_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_gender_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_race_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_gender_by_race_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_gender_by_age_group_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_age_group_by_race_mobile_consumption_f1.csv',
      'raw_data/PHN+TAB_by_state_mobile_consumption_f1.csv',
      # # # streaming 
